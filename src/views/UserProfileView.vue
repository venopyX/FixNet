      ...
      <div class="container mx-auto px-6">
        <div class="max-w-6xl mx-auto">
          ...
          <div v-if="!user" class="claycard bg-surface rounded-3xl p-12 text-center">
            <div class="w-24 h-24 bg-error/10 rounded-full flex items-center justify-center mx-auto mb-6">
              <svg class="w-12 h-12 text-error" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
