<template>
  <nav class="fixed top-0 w-full bg-surface/95 backdrop-blur-sm border-b border-border/50 z-50 transition-all duration-300">
    <div class="container mx-auto px-6">
      <div class="flex items-center justify-between h-16">
        <!-- Logo -->
        <div class="flex items-center">
          <router-link to="/" class="flex items-center space-x-3" @click.prevent="handleLogoClick">
            <div class="claycard w-10 h-10 bg-gradient-to-br from-primary to-secondary rounded-2xl flex items-center justify-center">
      ...
      <Transition name="slide-down">
        <div v-if="showMobileMenu" class="md:hidden">
          <div class="claycard bg-surface/95 backdrop-blur-sm border border-border/50 rounded-2xl mt-4 mb-4 p-4 shadow-lg">
            <!-- Navigation Links -->
              ...
              <div class="px-4 py-2">
                <div class="claycard bg-primary/10 text-primary px-4 py-3 rounded-xl text-center">
                  <div class="flex items-center justify-center gap-2 mb-1">
                    ...
                    <span class="font-medium">{{ currentUser?.first_name }} {{ currentUser?.last_name }}</span>
                  </div>
