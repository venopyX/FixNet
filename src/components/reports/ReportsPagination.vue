        ...
        <div class="flex items-center gap-2">
          ...
          <div class="flex items-center gap-1">
            ...
            <button
              ...
              :class="currentPage === 1 ? 'bg-primary text-white' : 'border border-border hover:border-primary text-text-secondary hover:text-primary'"
            >
              1
            </button>
            ...
            <button
              ...
              @click="goToPage(page)"
              class="claybutton w-10 h-10 flex items-center justify-center rounded-xl text-sm font-medium transition-all duration-200"
              :class="currentPage === page ? 'bg-primary text-white' : 'border border-border hover:border-primary text-text-secondary hover:text-primary'"
            >
              {{ page }}
            </button>
            ...
            <button
              ...
              class="claybutton w-10 h-10 flex items-center justify-center rounded-xl text-sm font-medium transition-all duration-200"
              :class="currentPage === totalPages ? 'bg-primary text-white' : 'border border-border hover:border-primary text-text-secondary hover:text-primary'"
            >
              {{ totalPages }}
            </button>
          </div>
