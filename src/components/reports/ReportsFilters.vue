            ...
            <div class="space-y-2">
              <label class="flex items-center">
                <input 
                  ...
                  class="sr-only"
                />
                <div class="claybutton flex items-center gap-3 w-full p-3 rounded-xl cursor-pointer transition-all duration-200"
                     :class="localStatus === 'all' ? 'bg-primary/10 border border-primary/20 text-primary' : 'bg-background hover:bg-muted text-text-secondary'"
                >
              ...
              <label class="flex items-center">
                ...
                />
                <div class="claybutton flex items-center gap-3 w-full p-3 rounded-xl cursor-pointer transition-all duration-200"
                     :class="localStatus === 'pending' ? 'bg-warning/10 border border-warning/20 text-warning' : 'bg-background hover:bg-muted text-text-secondary'"
                >
                  <div class="w-4 h-4 rounded-full border-2 flex items-center justify-center"
                       :class="localStatus === 'pending' ? 'border-warning' : 'border-border'"
                  >
                    <div v-if="localStatus === 'pending'" class="w-2 h-2 bg-warning rounded-full"></div>
                  </div>
              ...
              <label class="flex items-center">
                ...
                />
                <div class="claybutton flex items-center gap-3 w-full p-3 rounded-xl cursor-pointer transition-all duration-200"
                     :class="localStatus === 'under_review' ? 'bg-info/10 border border-info/20 text-info' : 'bg-background hover:bg-muted text-text-secondary'"
                >
                  <div class="w-4 h-4 rounded-full border-2 flex items-center justify-center"
                       :class="localStatus === 'under_review' ? 'border-info' : 'border-border'"
                  >
                    <div v-if="localStatus === 'under_review'" class="w-2 h-2 bg-info rounded-full"></div>
                  </div>
              ...
              <label class="flex items-center">
                ...
                />
                <div class="claybutton flex items-center gap-3 w-full p-3 rounded-xl cursor-pointer transition-all duration-200"
                     :class="localStatus === 'resolved' ? 'bg-success/10 border border-success/20 text-success' : 'bg-background hover:bg-muted text-text-secondary'"
                >
                  <div class="w-4 h-4 rounded-full border-2 flex items-center justify-center"
                       :class="localStatus === 'resolved' ? 'border-success' : 'border-border'"
                  >
                    <div v-if="localStatus === 'resolved'" class="w-2 h-2 bg-success rounded-full"></div>
                  </div>
          ...
          <div>
            ...
            <div class="space-y-2">
              <label class="flex items-center">
                ...
                />
                <div class="claybutton flex items-center gap-3 w-full p-3 rounded-xl cursor-pointer transition-all duration-200"
                     :class="localPriority === 'all' ? 'bg-primary/10 border border-primary/20 text-primary' : 'bg-background hover:bg-muted text-text-secondary'"
                >
                  <div class="w-4 h-4 rounded-full border-2 flex items-center justify-center"
              ...
              <label class="flex items-center">
                ...
                />
                <div class="claybutton flex items-center gap-3 w-full p-3 rounded-xl cursor-pointer transition-all duration-200"
                     :class="localPriority === 'high' ? 'bg-error/10 border border-error/20 text-error' : 'bg-background hover:bg-muted text-text-secondary'"
                >
                  <div class="w-4 h-4 rounded-full border-2 flex items-center justify-center"
              ...
              <label class="flex items-center">
                ...
                />
                <div class="claybutton flex items-center gap-3 w-full p-3 rounded-xl cursor-pointer transition-all duration-200"
                     :class="localPriority === 'medium' ? 'bg-warning/10 border border-warning/20 text-warning' : 'bg-background hover:bg-muted text-text-secondary'"
                >
                  <div class="w-4 h-4 rounded-full border-2 flex items-center justify-center"
                       :class="localPriority === 'medium' ? 'border-warning' : 'border-border'"
                  >
                    <div v-if="localPriority === 'medium'" class="w-2 h-2 bg-warning rounded-full"></div>
                  </div>
              ...
              <label class="flex items-center">
                ...
                />
                <div class="claybutton flex items-center gap-3 w-full p-3 rounded-xl cursor-pointer transition-all duration-200"
                     :class="localPriority === 'low' ? 'bg-info/10 border border-info/20 text-info' : 'bg-background hover:bg-muted text-text-secondary'"
                >
                  <div class="w-4 h-4 rounded-full border-2 flex items-center justify-center"
