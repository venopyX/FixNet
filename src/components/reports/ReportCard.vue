<template>
    ...
    >
      ...
      <!-- Content -->
      <div class="mb-4">
        <h3 class="text-lg font-semibold text-text-primary group-hover:text-primary transition-colors mb-2 line-clamp-2">
          {{ report.title }}
        </h3>
      ...
      <div v-if="report.photo_url" class="mb-4">
        <div class="w-full h-32 bg-gradient-to-br from-primary/10 to-secondary/10 rounded-2xl flex items-center justify-center">
