<template>
    <div class="claycard bg-gradient-to-r from-primary/5 via-secondary/5 to-accent/5 rounded-3xl p-8 relative overflow-hidden">
      ...
      <div class="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-br from-accent/10 to-info/10 rounded-full blur-3xl"></div>
      ...
      <div class="relative z-10">
        <div class="flex flex-col lg:flex-row lg:items-center gap-8">
          ...
          <div class="flex items-center gap-6">
            <!-- Avatar -->
            <div class="claycard w-24 h-24 bg-gradient-to-br from-primary/20 to-secondary/20 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div class="flex flex-wrap items-center gap-4 text-sm">
                ...
                <div class="claycard bg-surface/80 px-3 py-2 rounded-xl flex items-center gap-2">
                  <svg class="w-4 h-4 text-accent" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3a4 4 0 118 0v4m-4 0v12m0-12h4a2 2 0 012 2v6a2 2 0 01-2 2H8a2 2 0 01-2-2V9a2 2 0 012-2z" />
                  </svg>
                  <span class="text-text-secondary">Joined {{ formatJoinDate(stats?.joinDate) }}</span>
                </div>
                
                <div v-if="stats?.impactScore" class="claycard bg-surface/80 px-3 py-2 rounded-xl flex items-center gap-2">
