    ...
    <div class="claycard bg-surface rounded-3xl p-6">
      <div class="flex items-center justify-between mb-6">
        ...
        <div class="claycard bg-background border border-border rounded-xl p-1 flex">
          <button
            ...
            :class="viewMode === 'recent' ? 'bg-primary text-white' : 'text-text-secondary hover:text-primary'"
          >
            Recent
          </button>
          <button
            ...
            class="claybutton px-3 py-1 rounded-lg text-sm font-medium transition-all duration-200"
            :class="viewMode === 'resolved' ? 'bg-primary text-white' : 'text-text-secondary hover:text-primary'"
          >
            Resolved
          </button>
        </div>
      ...
      <div v-if="filteredReports.length > 0" class="space-y-4">
        ...
        >
          ...
          <h4 class="font-semibold text-text-primary group-hover:text-primary transition-colors mb-2 line-clamp-2">
            {{ report.title }}
          </h4>
