...
export const mockReports: Report[] = [
  {
    ...
    description:
      'There is a dangerous pothole near the intersection of Main Street and Oak Avenue. It has been growing larger and is causing damage to vehicles.',
    category: 'roads',
  ...
  },
  {
    ...
    description:
      'The streetlight at the corner of Pine Street is not working, making the area unsafe at night.',
  ...
  },
  {
    ...
    description:
      'The public garbage bin near the park entrance has been overflowing for several days.',
    category: 'waste',
...
export const mockStatusUpdates: StatusUpdate[] = [
  {
    ...
    admin_comment:
      'Report received and assigned to road maintenance team. Inspection scheduled for tomorrow.',
  ...
  },
  {
    ...
    new_status: 'resolved',
    admin_comment:
      'Streetlight has been repaired and is now working properly. Thank you for reporting this issue.',
    updated_by: 'Admin User',
